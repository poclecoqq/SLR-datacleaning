...
def filtering_papers(papers):
    ...
    """
    return papers[~papers['Relevant'].isin(['NO', 'score too low', 'not sure', 'exclusion criteria', 'Not accessible'])]
...
def main():
    ...
    s_papers_names = extract_names(
        pandas.read_csv(input_dir/'snowballing.csv'))
